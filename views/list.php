...
jQuery(document).ready(function()
{
	...
	var nHTML = "<div class='grid-box width100 grid-v'><div class='module mod-box widget_nav_menu deepest'><h3 class='module-title'><span class='color'>GPC</span> Account</h3><ul class='menu menu-sidebar'><li class='level1 item28759'><a class='level1' href='?a=m'><span>My Scripts</span></a></li></ul></div></div>";
	var oHTML = jQuery("#sidebar-a").html();
	jQuery("#sidebar-a").html( nHTML + oHTML );
